========================================================================
    KONSOLENANWENDUNG: ETX_ACK_Sender-Projektübersicht
========================================================================

Diese ETX_ACK_Sender-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ETX_ACK_Sender-Anwendung besteht.


ETX_ACK_Sender.vcxproj
...
ETX_ACK_Sender.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ETX_ACK_Sender.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
